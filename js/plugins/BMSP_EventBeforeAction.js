...
(function() {
    ...
    $gameVariables.setValue(132, subject._actorId);
    ...
    BattleManager.processTurn = function() {
        ...
        if(subject && action && action.isValid2()){
            this.startEventBeforeInvokeAction(action, subject, this._targets);
        }
    };
    
    Game_Action.prototype.isValid2 = function() {
    ...
    $gameSwitches.setValue(228, false);
    $gameSwitches.setValue(230, false);
    $gameSwitches.setValue(232, false);
    $gameSwitches.setValue(232, false);
    $gameSwitches.setValue(363, false);
    $gameSwitches.setValue(364, false);
    $gameSwitches.setValue(231, false);
    $gameSwitches.setValue(226, false);
