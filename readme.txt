...
次に、東側の山にいるNPCと話し、奥に進んでください。土砂をチェックしたら戻って、NPCと話します。
...
■アプリ版での確認されている現象
・プレー時間が長くなると（メモリや温度など環境による）突然アプリが強制終了する可能性があります。
・スリープや画面ロック後、再開した場合、著しいラグが発生したり、上記の強制終了がおきやすくなることがあります

＠可能と思われる推奨対策
・セーブをこまめにする（ファイル１のオートセーブ以外のデータに）
・なるべく他の実行していないアプリは終了させる
・電源が十分な状態でプレーする（省エネモードでアプリ動作が悪くなる可能性があります）
・スリープや画面ロックで画面を一度消し、再び戻したときは、セーブしてからアプリを一度終了し、再開する
